...
3. rosbag record -a
4. rosrun kalibr kalibr_calibrate_cameras --target checkerboard.yaml --bag <bagpath> --models pinhole-radtan pinhole-radtan --topics /cam1/image_raw /cam0/image_raw
